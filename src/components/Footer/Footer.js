    ...
    <footer>
      <div className="footer__container">
          ...
          <div className="footer__contact__container">
            ...
            <ul className="footer__contacts">
              <li className="footer__contact">
                <LocalPhoneIcon /> <span>+91 8431226186</span>
              </li>
              <li className="footer__contact">
                <EmailIcon /> <span>YD@gmail.com</span>
              </li>
              <li className="footer__contact">
          ...
          <div className="footer__social__link__container">
            ...
            <ul className="footer__social__links">
              <li className="social__link">
                <a href="https://twitter.com/Yuvaraj_D_">
                  <TwitterIcon />
                </a>
              </li>
              <li className="social__link">
        ...
        <div className="fotter__copyright__container">
          <ul className="nav">
            <li className="footer__copyright">©2023 yd store Ltd. |</li>
